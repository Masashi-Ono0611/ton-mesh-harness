export interface CliOptions {
  ...
  announceIp?: string                      // #69: public IPv4 to announce (cloud seeder); overrides MESH_ANNOUNCE_IP
  announcePort?: number                    // #69: fixed UDP ListenAddr port; overrides MESH_ANNOUNCE_PORT
